...
ANTHROPIC_BASE_URL=${ANTHROPIC_BASE_URL:-http://100.64.0.132:8906/v1}
export ANTHROPIC_BASE_URL

CLAUDE_CODE_SESSION_EVENT_URL=${CLAUDE_CODE_SESSION_EVENT_URL:-http://100.64.0.132:8906/_agent/session-event}
